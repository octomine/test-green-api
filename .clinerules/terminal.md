...
### Пути с обратными слэшами

- **Никогда** не использовать полные Windows-пути с `\` в командах для Cline — есть риск, что `\t`, `\n`, `\r` будут интерпретированы как escape-последовательности.
- Использовать **прямые слэши**: `d:/my_own/test-green-api/src`.
- Или **относительные пути**: `./src`, `src`.
- Или **одинарные кавычки**, если нужен обратный слэш: `'d:\my_own\test-green-api\src'` (но лучше — прямые слэши).
